...
url_claim = 'https://alb.seeddao.org/api/v1/seed/claim'
url_balance = 'https://alb.seeddao.org/api/v1/profile/balance'
url_checkin = 'https://alb.seeddao.org/api/v1/login-bonuses'
url_upgrade_storage = 'https://alb.seeddao.org/api/v1/seed/storage-size/upgrade'
url_upgrade_mining = 'https://alb.seeddao.org/api/v1/seed/mining-speed/upgrade'
url_upgrade_holy = 'https://alb.seeddao.org/api/v1/upgrades/holy-water'
url_get_profile = 'https://alb.seeddao.org/api/v1/profile2'
...
def check_worm():
    response = requests.get('https://alb.seeddao.org/api/v1/worms', headers=headers)
...
def catch_worm():
    ...
    if worm_data and not worm_data['is_caught']:
        response = requests.post('https://alb.seeddao.org/api/v1/worms/catch', headers=headers)
        if response.status_code == 200:
...
def get_tasks():
    ...
    response = requests.get('https://alb.seeddao.org/api/v1/tasks/progresses', headers=headers)
...
def complete_task(task_id,task_name):
    ...
    response = requests.post(f'https://alb.seeddao.org/api/v1/tasks/{task_id}', headers=headers)
    if response.status_code == 200:
