...
class Clayton {
    ...
    async login(initData) {
        const url = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/user/authorization";
    ...
    async dailyClaim(initData) {
        const url = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/user/daily-claim";
        const headers = { ...this.headers, "Init-Data": initData };
        try {
            const response = await axios.post(url, {}, { headers });
            if (response.status === 200) {
    ...
    async startFarm(initData) {
        const url = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/game/start";
        const headers = { ...this.headers, "Referer": "https://tonclayton.fun/games", "Init-Data": initData };
        try {
            const response = await axios.post(url, {}, { headers });
            if (response.status === 200) {
                return { success: true, data: response.data };
    ...
    async claimFarm(initData) {
        const url = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/user/claim";
        const headers = { ...this.headers, "Init-Data": initData };
        try {
            const response = await axios.post(url, {}, { headers });
            if (response.status === 200) {
    ...
    async getPartnerTasks(initData) {
        const url = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/tasks/partner-tasks";
        const headers = { ...this.headers, "Init-Data": initData };
        try {
            const response = await axios.post(url, {}, { headers });
            this.log(response);
    ...
    async completePartnerTask(initData, taskId) {
        const url = `https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/tasks/partner-tasks/complete/${taskId}`;
        const headers = { ...this.headers, "Init-Data": initData };
        try {
            const response = await axios.post(url, {}, { headers });
            if (response.status === 200) {
    ...
    async rewardPartnerTask(initData, taskId) {
        const url = `https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/user/partner/reward/${taskId}`;
        const headers = { ...this.headers, "Init-Data": initData };
        try {
            const response = await axios.post(url, {}, { headers });
            if (response.status === 200) {
    ...
    async handleTwitterTask(initData) {
        const checkUrl = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/tasks/default-tasks";
        const claimUrl = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/tasks/default-tasks/claim";
        const headers = { ...this.headers, "Init-Data": initData };
    ...
    async handleBotTask(initData) {
        const checkUrl = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/user/task-bot";
        const claimUrl = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/user/task-bot-claim";
        const headers = { ...this.headers, "Init-Data": initData };
    ...
    async handleDailyTasks(initData) {
        const dailyTasksUrl = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/tasks/daily-tasks";
        const headers = { ...this.headers, "Init-Data": initData };
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                for (const task of uncompletedTasks) {
                    const completeUrl = `https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/tasks/daily-task/${task.id}/complete`;
                    const claimUrl = `https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7/tasks/daily-task/${task.id}/claim`;
...
//                this.log(`Lỗi khi xử lý nhiệm vụ hàng ngày: ${error.message}`, 'error');
    ...
    async playGame(initData) {
        const headers = { ...this.headers, "Init-Data": initData };
        const baseUrl = "https://tonclayton.fun/api/cc82f330-6a6d-4deb-a15b-6a332a67ffa7";
        ...
        while (true) {
            ...
            while (startAttempts < 1 && !gameStarted) {
                try {
                    const startGameResponse = await axios.post(`${baseUrl}/game/start`, {}, { headers });
            ...
            for (const milestone of allMilestones) {
                ...
                try {
                    const saveGameResponse = await axios.post(`${baseUrl}/game/save-tile`, { maxTile: milestone, sessoin_id: sessoin_id }, { headers });
            ...
            try {
                const endGameResponse = await axios.post(`${baseUrl}/game/over`, {}, { headers });
