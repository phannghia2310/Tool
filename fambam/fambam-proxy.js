...
class Fambam {
  ...
  async getMe(metaverseId, token, axiosInstance) {
  ...
  async claimPoint(metaverseId, token, axiosInstance) {
    const url =
  ...
  async handleClaimPoint(metaverseId, token, axiosInstance) {
    try {
      const claim = await this.claimPoint(metaverseId, token, axiosInstance);
  ...
  async openBox(metaverseId, token, numBox, axiosInstance) {
    const url =
  ...
  async getBoxInfo(metaverseId, token, axiosInstance) {
