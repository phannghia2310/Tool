...
class Bums {
    ...
    async finishTask(token, taskId, taskInfo, proxyUrl) {
        ...
        const episodeCodes = {
            58: "61306", 59: "55380", 60: "71506", 61: "46336", 62: "74624", 63: "20437"
        };
        ...
        while (true) {
            for (let i = 0; i < data.length; i++) {
                ...
                try {
                    ...
                    console.log(`\n========== Tài khoản ${i + 1}/${data.length} | ${firstName.green} | ip: ${proxyIP} ==========`);
                    
                    this.log(`Đang đăng nhập...`, 'info');
                    const loginResult = await this.login(initData, 'ref_4xYSLDUj', currentProxy);
