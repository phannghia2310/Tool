...
class DuckChainAPIClient {
    ...
    async getUserInfo(authorization, proxyUrl) {
        try {
            ...
            const response = await axiosInstance.get('https://bbc.duckchain.io/user/info', {
                headers: {
                    ...this.headers,
    ...
    async setDuckName(authorization, duckName, proxyUrl) {
        try {
            ...
            const response = await axiosInstance.get(`https://bbc.duckchain.io/user/set_duck_name?duckName=${encodedDuckName}`, {
                headers: {
                    ...this.headers,
    ...
    async getTaskList(authorization, proxyUrl) {
        try {
            const axiosInstance = this.createAxiosInstance(proxyUrl);
            const response = await axiosInstance.get('https://bbc.duckchain.io/task/task_list', {
                headers: {
                    ...this.headers,
                    'Authorization': `tma ${authorization}`
                }
    ...
    async getTaskInfo(authorization, proxyUrl) {
        try {
            const axiosInstance = this.createAxiosInstance(proxyUrl);
            const response = await axiosInstance.get('https://bbc.duckchain.io/task/task_info', {
                headers: {
                    ...this.headers,
                    'Authorization': `tma ${authorization}`
                }
    ...
    async performDailyCheckIn(authorization, proxyUrl) {
        try {
            const axiosInstance = this.createAxiosInstance(proxyUrl);
            const response = await axiosInstance.get('https://bbc.duckchain.io/task/sign_in', {
                headers: {
                    ...this.headers,
                    'Authorization': `tma ${authorization}`
                }
    ...
    async completeTask(authorization, task, proxyUrl) {
        try {
            const axiosInstance = this.createAxiosInstance(proxyUrl);
            const response = await axiosInstance.get(`https://bbc.duckchain.io/task/onetime?taskId=${task.taskId}`, {
                headers: {
                    ...this.headers,
                    'Authorization': `tma ${authorization}`
                }
    ...
    async completeTask2(authorization, task, proxyUrl) {
        try {
            const axiosInstance = this.createAxiosInstance(proxyUrl);
            const response = await axiosInstance.get(`https://bbc.duckchain.io/task/partner?taskId=${task.taskId}`, {
                headers: {
                    ...this.headers,
                    'Authorization': `tma ${authorization}`
                }
    ...
    async collectDailyEgg(authorization, proxyUrl) {
        try {
            ...
            const checkResponse = await axiosInstance.get('https://bbc.duckchain.io/property/daily/isfinish?taskId=1', {
                headers: {
                    ...this.headers,
                    'Authorization': `tma ${authorization}`
                }
            ...
            if (checkResponse.data.code === 200) {
                if (checkResponse.data.data === 0) {
                    ...
                    const collectResponse = await axiosInstance.get('https://bbc.duckchain.io/property/daily/finish?taskId=1', {
                        headers: {
                            ...this.headers,
                            'Authorization': `tma ${authorization}`
                        }
    ...
    async executeQuack(authorization, proxyUrl) {
        try {
            const axiosInstance = this.createAxiosInstance(proxyUrl);
            const response = await axiosInstance.get('https://bbc.duckchain.io/quack/execute', {
                headers: {
                    ...this.headers,
                    'Authorization': `tma ${authorization}`
                }
