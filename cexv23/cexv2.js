...
class CexAPI {
    ...
    async getUserInfo(authData) {
        const url = "https://app.cexptap.com/api/v2/getUserInfo";
        const payload = {
    ...
    async claimCrypto(authData) {
        const url = "https://app.cexptap.com/api/v2/claimCrypto";
        const payload = {
            devAuthData: authData.id,
            authData: authData.authString,
            platform: "android",
    ...
    async rstap(authData, multiTapsEnergy) {
        const url = "https://app.cexptap.com/api/v2/claimMultiTaps";
        const payload = {
            devAuthData: authData.id,
            authData: authData.authString,
            platform: "android",
    ...
    async getGameConfig(authData) {
        const url = "https://app.cexptap.com/api/v2/getGameConfig";
        const payload = {
            devAuthData: authData.id,
            authData: authData.authString,
            platform: "android",
    ...
    async getUserCards(authData) {
        const url = "https://app.cexptap.com/api/v2/getUserCards";
        const payload = {
            devAuthData: authData.id,
            authData: authData.authString,
            platform: "android",
    ...
    async buyUpgrade(authData, upgradeData) {
        const url = "https://app.cexptap.com/api/v2/buyUpgrade";
        const payload = {
            devAuthData: authData.id,
            authData: authData.authString,
            platform: "android",
    ...
    async getConvertData(authData) {
        const url = "https://app.cexptap.com/api/v2/getConvertData";
        const payload = {
            devAuthData: authData.id,
            authData: authData.authString,
            platform: "android",
    ...
    async convertCrypto(authData, userData) {
        const url = "https://app.cexptap.com/api/v2/convert";
        const lastPrice = await this.getConvertData(authData);
        const fromAmount = (userData.balance_BTC / 10000).toFixed(5);
