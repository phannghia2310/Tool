...
class Clayton {
    ...
    async login(initData) {
        const url = "https://tonclayton.fun/api/user/authorization";
    ...
    async startFarm(initData) {
        const url = "https://tonclayton.fun/api/game/start";
        const headers = { ...this.headers, "Init-Data": initData };
        try {
            const response = await axios.post(url, {}, { headers });
            if (response.status === 200) {
    ...
    async getPartnerTasks(initData) {
        const url = "https://tonclayton.fun/api/tasks/partner-tasks";
        const headers = { ...this.headers, "Init-Data": initData };
        try {
            const response = await axios.post(url, {}, { headers });
            this.log(response);
    ...
    async handleDailyTasks(initData) {
        const dailyTasksUrl = "https://tonclayton.fun/api/tasks/daily-tasks";
        const headers = { ...this.headers, "Init-Data": initData };
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                for (const task of uncompletedTasks) {
                    const completeUrl = `https://tonclayton.fun/api/tasks/daily-task/${task.id}/complete`;
                    const claimUrl = `https://tonclayton.fun/api/tasks/daily-task/${task.id}/claim`;
